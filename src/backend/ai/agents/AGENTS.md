...
> See [import-paths.md](../../../.agent/rules/import-paths.md) for the mandatory `@/` import path standard.
> **Every import in this project must use an `@/` alias. Relative imports (`./`, `../`) are FORBIDDEN.**
